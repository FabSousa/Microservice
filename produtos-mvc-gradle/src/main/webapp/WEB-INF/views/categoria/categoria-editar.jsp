	        ...
	        <div class="row">
	            <div class="col-lg-12">
	                <div class="well">
						...
						<form:form modelAttribute="categoriaModel" action="${contextPath}/categoria/${categoriaModel.idCategoria}" method="post">
						    ...
						    <div class="form-group">
								<form:input type="hidden" name="idCategoria" id="idCategoria" path="idCategoria" value="${categoriaModel.idCategoria}" />
	                        </div>
							
							<div class="form-group">
								<label class="control-label" for="nomeCategoria">Nome:</label>
								<form:input type="text" name="nomeCategoria" id="nomeCategoria" path="nomeCategoria" value="${categoriaModel.nomeCategoria}" class="form-control" maxlength="50" size="50" oninvalid="this.setCustomValidity('Enter User Name Here')" oninput="setCustomValidity('')"/>
