				...
				<div class="row">
					<div class="col-md-12">
						...
						<a class="btn btn-secondary"
							href="${contextPath}/marcas/form?page=marca-novo">Nova
							marca</a>
				...
				<tbody>
					<c:forEach items="${marcas}" var="marca">
						<tr>
							...
							<td><form:form
									action="${contextPath}/marcas/${marca.idMarca}"
									method="delete">
									<a href="${contextPath}/marcas/${marca.idMarca}"
										class="btn btn-success btn-sm">Detalhes</a>

									<a
										href="${contextPath}/marcas/form?page=marca-editar&id=${marca.idMarca}"
