		        ...
		        <div class="row">
		            <div class="col-lg-12">
		                <div class="well">
							...
							<h2 class="text-danger fonte-titulo texto-cor-especial">Produto</h2>
							
							<form action="${contextPath}/produto/edit/${id}" method="post">
							
								<div class="form-group">
									<label class="control-label" for="nome">Nome:</label>
									<input type="text" name="nome" id="nome" value="${produto.nome}" class="form-control" maxlength="50" size="50" required/>
		                        </div>
		                        <div class="form-group">
									<label class="control-label" for="sku">SKU:</label>
									<input type="text" name="sku" id="sku" value="${produto.sku}" class="form-control" maxlength="50" size="50" required/>
								</div>
								
								<div class="form-group">
									<label class="control-label" for="descricao">Descrição:</label>
									<textarea class="form-control" name="descricao" id="descricao" rows="4" cols="100" required>${produto.descricao}</textarea>
								</div>
								
								<div class="form-group">
									<label class="control-label" for="preco">Preço:</label>
									<input type="number" id="preco" value="${produto.preco}" name="preco" step=".01" class="form-control" required/>
								</div>
								
								<div class="form-group">
									<label class="control-label" for="caracteristica">Características:</label>
									<textarea id="caracteristica" class="form-control" name="caracteristica" rows="4" cols="100" required>${produto.caracteristica}</textarea>
								</div>
								<hr>
