		...
		<header>
			<nav class="navbar navbar-dark bg-dark">
			  <div class="container-fluid">
			    <a class="navbar-brand fonte-titulo" href="${contextPath}/categorias">Categorias</a>
			  </div>
			</nav>
		</header>
	                ...
	                <div class="well">
						...
						<form:form modelAttribute="categoriaModel" action="${contextPath}/categorias/${categoriaModel.id}" method="put">
							...
							<div class="form-group">
								...
								<form:input type="text" name="nome" id="nome" path="nome" value="${categoriaModel.nome}" class="form-control" maxlength="50" size="50" oninvalid="this.setCustomValidity('Enter User Name Here')" oninput="setCustomValidity('')"/>
