				...
				<div class="row">
					<div class="col-md-12">
						...
						<a class="btn btn-secondary"
							href="${contextPath}/categorias/form?page=categoria-novo">Nova
							Categoria</a>
				...
				<tbody>
					<c:forEach items="${categorias}" var="categoria">
						<tr>
							...
							<td><form:form
									action="${contextPath}/categorias/${categoria.idCategoria}"
									method="delete">
									<a href="${contextPath}/categorias/${categoria.idCategoria}"
										class="btn btn-success btn-sm">Detalhes</a>

									<a
										href="${contextPath}/categorias/form?page=categoria-editar&id=${categoria.idCategoria}"
